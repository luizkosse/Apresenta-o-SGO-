...
function DevStory() {
  ...
  const quotes = [
    ...
    },
    {
      ...
      tone: 'b',
      body: [
        'Desenvolver o SGO com o Claude Code mudou a forma como eu encaro IA no trabalho. Não foi uma ferramenta entregando código pronto — foi um time de agentes me obrigando a entender, decidir e aprovar em cada etapa. E essa estrutura fez toda a diferença.',
        'O que mais me surpreendeu foi o quanto aprendi no caminho. Redis, WebSocket, NestJS, MongoDB, MCP Server — tecnologias que antes eram só nomes no projeto viraram conhecimento real, porque o pipeline não me deixava avançar sem antes ler a spec do PO, validar a arquitetura proposta e questionar o que não fazia sentido. A IA escreveu o código, mas as decisões passaram por mim.',
        'E é isso que levo dessa experiência: aprendi a ler antes da IA executar. Saí mais crítico, mais exigente, e com domínio real sobre o sistema que ajudei a construir.',
        'Não é sobre a IA ser rápida. É sobre eu ser dono do que está sendo feito.',
      ],
    },
  ];
